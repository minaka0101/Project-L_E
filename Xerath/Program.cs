...
namespace Xerath
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Utility.HpBarDamageIndicator.DamageToUnit += hero => (float)Player.LSGetSpellDamage(hero, SpellSlot.R) * new int[] {0, 3, 4, 5 }[Player.GetSpell(SpellSlot.R).Level];
        ...
        private static void UseSpells(bool useQ, bool useW, bool useE)
        {
           ...
           Hacks.DisableRangeIndicator = Q.IsCharging && useQ;
        ...
        private static void Farm(bool laneClear)
        {
            ...
            Hacks.DisableRangeIndicator = Q.IsCharging && useQi != 0;
