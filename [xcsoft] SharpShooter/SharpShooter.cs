    ...
    internal static class SharpShooter
    {
        ...
        internal static void Load()
        {
	        ...
	        catch
	        {
                ...
                Chat.Print("<font color = \"#00D8FF\">[xcsoft] SharpShooter: </font><font color = \"#FF007F\">" + Player.ChampionName + "</font> Not supported");
		        return;
	        }
            ...
            Chat.Print("<font color = \"#00D8FF\">[xcsoft] SharpShooter:</font> <font color = \"#FF007F\">" + Player.ChampionName + "</font> Loaded");
            Chat.Print("<font color = \"#00D8FF\">[xcsoft] SharpShooter:</font> This SharpShooter is Old Version, Please Use 'SharpShooter Reworked'.");
        }
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (drawMinionLastHit.Active || drawMinionNearKill.Active)
            {
                ...
                {
                    if (drawMinionLastHit.Active && Player.LSGetAutoAttackDamage(xMinion, true) >= xMinion.Health)
                        Render.Circle.DrawCircle(xMinion.Position, xMinion.BoundingRadius, drawMinionLastHit.Color, 5);
                    else if (drawMinionNearKill.Active && Player.LSGetAutoAttackDamage(xMinion, true) * 2 >= xMinion.Health)
