...
namespace Sharpshooter
{
    ...
    {
        public static bool isKillableAndValidTarget(this AIHeroClient Target, double CalculatedDamage, float distance = float.MaxValue)
        {
            ...
            return Target.Health + Target.HPRegenRate + Target.AllShield <= CalculatedDamage;
        }
