namespace BrianSharp.Common
{
    ...
    internal class _Orbwalker :LeagueSharp.Common.Orbwalking.Orbwalker
    {
        ...
        public _Orbwalker(Menu add):base(add)
        {
            config = add;
            //var _Orbwalker1 = new _Orbwalker(mainMenu.SubMenu("Orbwalker"));
        ...
        {
            OnStopCast(sender.Spellbook, args);
        }
        ...
        {
            if (target.LSIsValidTarget() && CanAttack && IsAllowedToAttack)
            {
